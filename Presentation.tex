...
\only<1>{
\begin{gather}
pancake: succ(|contains\cap Milk|\geq |contains\cap Flavour|)\,\sqcap\nonumber 
\end{gather}
\begin{gather}
succ(|contains\cap Milk|\leq 2\cdot|contains\cap Flavour|)\,\sqcap \nonumber
\end{gather}
\begin{gather}
...
\only<2>{
\begin{gather}
pancake: succ(|contains\cap Milk|\geq |contains\cap Flavour|)\,\textcolor{red}{\sqcap}\nonumber 
\end{gather}
\begin{gather}
succ(|contains\cap Milk|\leq 2\cdot|contains\cap Flavour|)\,\textcolor{red}{\sqcap }\nonumber
\end{gather}
\begin{gather}
succ(|contains\cap Egg|\geq 1)\nonumber
\end{gather}
...
We use the $\sqcap$-twice and add \\
\pause
\begin{gather}
