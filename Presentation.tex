...
\begin{frame}\frametitle{Example}
\begin{itemize}
\item impossible to decompose further
\item $successor$-rule has not been applied yet
\end{itemize}
\vspace*{1cm}
\pause
$\rightarrow$ Apply $successor$-rule next!\\
\end{frame}
\begin{frame}\frametitle{Example}
Let $c=|is\cap(Strawberry\cup Tangerine\cup Apple)|\geq 1$\\
\vspace*{0.1cm}
\begin{figure}[H]
\centering
\begin{tikzpicture}
