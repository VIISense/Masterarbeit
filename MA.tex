...
\end{align*}
\end{mydef}
We want to split $|s_1\cup s_2\cup\dots \cup s_n|$ into set terms such that they are disjoint to each other. This helps to determinate the all properties of successors in $k$.\\
