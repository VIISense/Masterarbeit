...
\end{align*} 
\item It is safe to merge two variable $y_1,y_2$ if by merging them we do not violate any assertions regarding $x$, for which we have $(x,y_1):s\in S$ and $(x,y_2):s\in S$, in $\mathcal{I}(S)$
\end{itemize}
