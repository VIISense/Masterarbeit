...
\begin{itemize}
\item $y:C$ iff $y_e\in\sigma^\ast(X_C)$, $C\in\mathbf{C}$
\item $y:succ(c)$ iff $y_e\in\sigma^\ast(X_{succ(c)})$
\item $(x,y):r$ iff $y_e\in\sigma^\ast(X_r)$
\item $y:\neg C$ iff $y_e\notin\sigma^\ast(X_C)$, $C\in\mathbf{C}$
\item $y:\neg succ(c)$ iff $y_e\notin\sigma^\ast(X_{succ(c)})$
\item $(x,y):r^\neg$ iff $y_e\notin\sigma^\ast(X_r)$
\end{itemize}
Because of the fact in (\dag) we can conclude
\begin{itemize}
\item $y:C$ iff $y_e\in\sigma(X_C)$, $C\in\mathbf{C}$
\item $y:succ(c)$ iff $y_e\in\sigma(X_{succ(c)})$
\item $(x,y):r$ iff $y_e\in\sigma(X_r)$
\item $y:\neg C$ iff $y_e\notin\sigma(X_C)$, $C\in\mathbf{C}$
\item $y:\neg succ(c)$ iff $y_e\notin\sigma(X_{succ(c)})$
\item $(x,y):r^\neg$ iff $y_e\notin\sigma(X_r)$
\end{itemize}
Since $\sigma$ is induced by $\mathcal{I}$ we find for each $y_e\in\sigma^\ast(\mathcal{U})$ an element $y^\mathcal{I}$ in $\Delta^\mathcal{I}$ such that:
\begin{itemize}
\item $y_e\in\sigma(X_C)$ iff $y^\mathcal{I}\in C^\mathcal{I}$, $C\in\mathbf{C}$
\item $y_e\in\sigma(X_{succ(c)})$ iff $y^\mathcal{I}\in succ(c)^\mathcal{I}$
\item $y_e\in\sigma(X_r)$ iff $(x^\mathcal{I},y^\mathcal{I})\in r^\mathcal{I}$
\item $y_e\notin\sigma(X_C)$, $C\in\mathbf{C}$ iff $y^\mathcal{I}\notin C^\mathcal{I}$, $C\in\mathbf{C}$
\item $y_e\notin\sigma(X_{succ(c)})$ iff $y^\mathcal{I}\notin succ(c)^\mathcal{I}$
\item $y_e\notin\sigma(X_r)$ iff $(x^\mathcal{I},y^\mathcal{I})\notin r^\mathcal{I}$
\end{itemize}
Therefore for each newly introduced individual name $y$ there is an element $y^\mathcal{I}$ such that:
\begin{itemize}
\item $y:C$ iff $y^\mathcal{I}\in C^\mathcal{I}$, $C\in\mathbf{C}$
\item $y:succ(c)$ iff $y^\mathcal{I}\in succ(c)^\mathcal{I}$
\item $(x,y):r$ iff $(x^\mathcal{I},y^\mathcal{I})\in r^\mathcal{I}$
\item $y:\neg C$ iff $y^\mathcal{I}\notin C^\mathcal{I}$, $C\in\mathbf{C}$
\item $y:\neg succ(c)$ iff $y^\mathcal{I}\notin succ(c)^\mathcal{I}$
\item $(x,y):r^\neg$ iff $(x^\mathcal{I},y^\mathcal{I})\notin r^\mathcal{I}$
\end{itemize}
