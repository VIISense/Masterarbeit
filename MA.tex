...
\end{algorithmic}
\end{algorithm}
Note that the blocking assertion is satisfied and at least $l$ must be of the form $n_1\cdot|s_1|+\dots+n_i\cdot|s_i|$.
