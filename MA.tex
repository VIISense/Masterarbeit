...
Let $S$ be a set of assertion, $x$ be a variable and $k$ be a cardinality term. The number of $x$'s successors which satisfies $k$ in the induced interpretation $\mathcal{I}(S)$ is denoted by $n_\mathcal{I}(x,k,S):=k^{\mathcal{I}_x}$.\\
