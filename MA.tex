...
\begin{tikzpicture}
  \begin{axis}[standard,
    ...
    \addlegendentry{$-x+5$}
    \addplot [fill=green, opacity=0.3] coordinates{(-1,-1) (1.333,3.666) (6,-1) (-1,-1)};
  \end{axis}
\end{tikzpicture}
\end{figure}
The green area encompasses the solutions of the systems. We can see that for certain $y$-values only a handful $x$-values hold the inequalities. For example if $y$ has the value of $1$ then the inequalities only holds if $x\in ]0,4[$.\\
...
\begin{tikzpicture}[scale=0.8]
  \begin{axis}[
    ...
    \addlegendentry{$3y<x$}
    \addplot[mark=none, color=green,line width=2pt]{1};
    \addlegendentry{$1\leq x$}
    \addplot[opacity=0.2, fill=blue] coordinates{(-.5,-1) (2,4) (-1,4) (-1,-1) (-0.5,-1)};
    \addplot[fill=green, opacity=0.2] coordinates{(-1,1)(6,1)(6,4)(-1,4)(-1,1)};
...
\begin{tikzpicture}[scale=0.8]
  \begin{axis}[
    ...
    \addplot[fill=green, opacity=0.2] coordinates{(-1,1) (6,1) (6,4) (-1,4) (-1,1)};
     ...
     \addplot[pattern=crosshatch dots, opacity=0.2] coordinates{(-1,1) (0.333,1) (1.333,4) (-1,4) (-1,1)};
  \end{axis}
\end{tikzpicture}
\end{minipage}
\end{figure}
