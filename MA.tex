...
\end{itemize} 
$\pi_\mathcal{I}$ satisfies an ABox $\mathcal{A}$ if $\pi_\mathcal{I}$ satisfies every assertion in $\mathcal{A}$. If $\pi_\mathcal{I}$ satisfies $S$ then $\mathcal{I}$ is a model of $\mathcal{A}$.
\end{mydef}
