...
\item the third component is a multiset of integers containing for each $x:succ(k\leq n)\in S$ the number of all successors $y$ of $x$ if rule \ref{choose} is applicable
