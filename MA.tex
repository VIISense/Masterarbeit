...
\begin{itemize}
\item $x:succ(k\leq l)$, which is violated
\item $(x,y_1):s_1$ and $(x,y_2):s_2$, such that $y_1\neq y_2$ and $k=n\cdot |s_1\cap s_2|+u$ or $k=n_1\cdot|s_1\cup t_1|+n_2\cdot|s_2\cup t_2|+u$, where $u$ is a cardinality term, $t_1,t_2$ are set terms, $n,n_1,n_2\in\mathbb{N}$
\end{itemize}
