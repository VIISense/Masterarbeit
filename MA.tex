...
\item $(x,y):s$ iff 
\begin{itemize}
\item for every positive role name $r$ in $s$ $(\pi_\mathcal{I}(x),\pi_\mathcal{I}(y))\in r^\mathcal{I}$
\item for every positive concept name $C$ in $s$ $\pi_\mathcal{I}(y)\in C^\mathcal{I}$
\item for every negated set term $s^\prime$ in $s$ we have at least one role name $r$ such that $(\pi_\mathcal{I}(x),\pi_\mathcal{I}(y))\not\in r^\mathcal{I}$ or at least one concept name $C$ such that $\pi_\mathcal{I}(y)\not\in C^\mathcal{I}$
\end{itemize}
\end{itemize} 
