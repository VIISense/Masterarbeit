...
\end{align*}
\end{ex}
We see that we need to decompose our ABox first into $S=\{x:succ(1\leq|succ(|A|\leq|B\cap r|)|), x:succ(|A|\leq |B|), x:C\}$. Then we can transform it into a formula by doing the following steps:
\begin{itemize}
