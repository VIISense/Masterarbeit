...
\end{itemize}
Hence we denote the \textit{merge coefficient} of two successor $y_1$ and $y_2$ of $x$ in a cardinality term $k$ by $\#k(x,y_1,y_2)$ and calculate it as follows (respectively for $\#l(x,y_1,y_2)$)
